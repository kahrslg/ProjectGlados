<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nonUserHomepage.aspx.cs" Inherits="Project_Glados_master.nonUserHomepage" %>
    ...
    <div style="margin: auto; align-items: center">
        <form id="form2" runat="server">
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataSourceID="SqlDataSource1" GridLines="None" HorizontalAlign="Center" Width="75%" AllowSorting="true">
                ...
                <Columns>
                    <asp:HyperLinkField DataTextField="Title" DataNavigateUrlFields="VideoGameId" HeaderText="Title" SortExpression="Title" ItemStyle-HorizontalAlign="Center" DataNavigateUrlFormatString="./nonUserVideoGameForm.aspx?VideoGameId={0}"/>
